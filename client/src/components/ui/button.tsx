...
const buttonVariants = cva(
  ...
  " hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-sm hover:shadow active:shadow-none",
        destructive:
          "bg-destructive text-destructive-foreground shadow-sm hover:shadow active:shadow-none",
        outline:
          "border border-border/50 shadow-xs hover:shadow-sm active:shadow-none",
        secondary: "bg-secondary text-secondary-foreground shadow-xs hover:shadow-sm active:shadow-none",
        ghost: "",
      },
      size: {
